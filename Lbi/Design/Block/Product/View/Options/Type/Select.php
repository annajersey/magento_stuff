 ...
 */
namespace Lbi\Design\Block\Product\View\Options\Type;
        ...
        if ($_option->getType() == \Magento\Catalog\Model\Product\Option::OPTION_TYPE_DROP_DOWN ||
            ...
            $select = $this->getLayout()->createBlock(
                ...
                [
                    ...
                    'class' => $require . ' product__select form-control'
                ]
            );
            if ($_option->getType() == \Magento\Catalog\Model\Product\Option::OPTION_TYPE_DROP_DOWN) {
                $select->setName('options[' . $_option->getid() . ']')->addOption('', __($_option->gettitle()));
            } else {
